// Minimal iOS device bezel — ported from the Claude Design project's
// ios-frame.jsx starter (status bar + dynamic island + home indicator only;
// the nav bar / list / keyboard pieces of that starter are unused by this
// app's mockup, which draws its own in-frame header per screen).
